...
export const CreateSection = ({
  ...
  const [isCreateNewUserButtonEnabled, setIsCreateNewUserButtonEnabled] =
    useState<boolean>(true);
  const [submitNewUserFeedback, setSubmitNewUserFeedback] =
    useState<SubmitNewUserFeedbackProps>({
      message: "",
      type: "default",
    });
  ...
  const handleSubmitCreateUser = async () => {
    setSubmitNewUserFeedback({ message: "Submitting...", type: "default" });
  ...
  return (
    <>
      <h3 className="text-2xl font-semibold tracking-tight">Create</h3>
      <div className="py-4 flex flex-col gap-4">
        ...
        {submitNewUserFeedback.message && (
          <Alert className="bg-transparent">
            <AlertTitle
              className={`text-center ${feedbackTextColorMap[submitNewUserFeedback.type]}`}
            >
              {submitNewUserFeedback.message}
            </AlertTitle>
          </Alert>
